...
Source0  : https://files.pythonhosted.org/packages/81/ce/910573eca7b1a1c6358b0dc0774ce1eeb81f4c98d4ee371f1c85f22040a1/referencing-0.32.1.tar.gz
...
%prep
%setup -q -n referencing-0.32.1
cd %{_builddir}/referencing-0.32.1
pushd ..
cp -a referencing-0.32.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704729284
