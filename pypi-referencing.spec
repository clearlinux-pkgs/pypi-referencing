...
Source0  : https://files.pythonhosted.org/packages/2f/db/98b5c277be99dd18bfd91dd04e1b759cad18d1a338188c936e92f921c7e2/referencing-0.36.2.tar.gz
...
%prep
%setup -q -n referencing-0.36.2
cd %{_builddir}/referencing-0.36.2
pushd ..
cp -a referencing-0.36.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737997664
