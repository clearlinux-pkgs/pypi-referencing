...
Source0  : https://files.pythonhosted.org/packages/27/32/fd98246df7a0f309b58cae68b10b6b219ef2eb66747f00dfb34422687087/referencing-0.36.1.tar.gz
...
%prep
%setup -q -n referencing-0.36.1
cd %{_builddir}/referencing-0.36.1
pushd ..
cp -a referencing-0.36.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737130618
