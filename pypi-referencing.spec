...
Source0  : https://files.pythonhosted.org/packages/21/c5/b99dd501aa72b30a5a87d488d7aa76ec05bdf0e2c7439bc82deb9448dd9a/referencing-0.33.0.tar.gz
...
%prep
%setup -q -n referencing-0.33.0
cd %{_builddir}/referencing-0.33.0
pushd ..
cp -a referencing-0.33.0 buildavx2
popd
pushd ..
cp -a referencing-0.33.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707137358
