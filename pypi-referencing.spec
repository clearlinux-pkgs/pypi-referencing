...
Source0  : https://files.pythonhosted.org/packages/59/d7/48b862b8133da2e0ed091195028f0d45c4d0be0f7f23dbe046a767282f37/referencing-0.34.0.tar.gz
...
%prep
%setup -q -n referencing-0.34.0
cd %{_builddir}/referencing-0.34.0
pushd ..
cp -a referencing-0.34.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710609889
